...
static inline vec2_t vec2cdiv(vec2_t a, vec2_t b) { return vec2(a.x / b.x, a.y / b.y); }
static inline vec3_t vec3cdiv(vec3_t a, vec3_t b) { return vec3(a.x / b.x, a.y / b.y, a.z / b.z); }
static inline vec4_t vec4cdiv(vec4_t a, vec4_t b) { return vec4(a.x / b.x, a.y / b.y, a.z / b.z, a.w / b.w); }
