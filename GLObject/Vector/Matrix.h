...
static inline mat4x3_t mat4x3rotatepivot(float angle, vec3_t axis, vec3_t pivot) { return mat4x3affinemul(mat4x3affine3x3(mat3x3rotate(angle, axis), pivot), mat4x3translate(vec3neg(pivot))); }
static inline mat4x4_t mat4x4rotatepivot(float angle, vec3_t axis, vec3_t pivot) { return mat4x4affinemul(mat4x4affine3x3(mat3x3rotate(angle, axis), pivot), mat4x4translate(vec3neg(pivot))); }
...
static inline mat2x2_t mat2x2smul(mat2x2_t a, float b) { mat2x2_t res = {0}; for(int i = 0; i < sizeof(a.m) / sizeof(a.m[0]); i++) res.m[i] = a.m[i] * b; return res; }
static inline mat3x2_t mat3x2smul(mat2x2_t a, float b) { mat3x2_t res = {0}; for(int i = 0; i < sizeof(a.m) / sizeof(a.m[0]); i++) res.m[i] = a.m[i] * b; return res; }
static inline mat3x3_t mat3x3smul(mat3x3_t a, float b) { mat3x3_t res = {0}; for(int i = 0; i < sizeof(a.m) / sizeof(a.m[0]); i++) res.m[i] = a.m[i] * b; return res; }
static inline mat4x3_t mat4x3smul(mat2x2_t a, float b) { mat4x3_t res = {0}; for(int i = 0; i < sizeof(a.m) / sizeof(a.m[0]); i++) res.m[i] = a.m[i] * b; return res; }
static inline mat4x4_t mat4x4smul(mat4x4_t a, float b) { mat4x4_t res = {0}; for(int i = 0; i < sizeof(a.m) / sizeof(a.m[0]); i++) res.m[i] = a.m[i] * b; return res; }

static inline mat2x2_t mat2x2sdiv(mat2x2_t a, float b) { mat2x2_t res = {0}; for(int i = 0; i < sizeof(a.m) / sizeof(a.m[0]); i++) res.m[i] = a.m[i] / b; return res; }
static inline mat3x2_t mat3x2sdiv(mat2x2_t a, float b) { mat3x2_t res = {0}; for(int i = 0; i < sizeof(a.m) / sizeof(a.m[0]); i++) res.m[i] = a.m[i] / b; return res; }
static inline mat3x3_t mat3x3sdiv(mat3x3_t a, float b) { mat3x3_t res = {0}; for(int i = 0; i < sizeof(a.m) / sizeof(a.m[0]); i++) res.m[i] = a.m[i] / b; return res; }
static inline mat4x3_t mat4x3sdiv(mat2x2_t a, float b) { mat4x3_t res = {0}; for(int i = 0; i < sizeof(a.m) / sizeof(a.m[0]); i++) res.m[i] = a.m[i] / b; return res; }
static inline mat4x4_t mat4x4sdiv(mat4x4_t a, float b) { mat4x4_t res = {0}; for(int i = 0; i < sizeof(a.m) / sizeof(a.m[0]); i++) res.m[i] = a.m[i] / b; return res; }
